 ...
 * 轻量的ProgressBar
 */
public class SmootHorizontalProgressBar extends View implements ISmoothTarget {
    ...
    public SmootHorizontalProgressBar(Context context) {
        super(context);
        init(context, null);
    }

    public SmootHorizontalProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SmootHorizontalProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SmootHorizontalProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        try {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.SmootHorizontalProgressBar);
            percent = typedArray.getFloat(R.styleable.SmootHorizontalProgressBar_mpb_percent, 0);
            fillColor = typedArray.getColor(R.styleable.SmootHorizontalProgressBar_mpb_fill_color, 0);
            backgroundColor = typedArray.getColor(R.styleable.SmootHorizontalProgressBar_mpb_background_color, 0);
            isFlat = typedArray.getBoolean(R.styleable.SmootHorizontalProgressBar_mpb_flat, false);
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
            }
